...
export const clientReferences: ClientReferenceGroup[] = [
  {
    ...
    clients: [
      ...
      { name: 'Selma Promotion Immobilière', logo: '/images/references/selma-promotion.png' },
    ],
  },
  {
    ...
    clients: [
      ...
      { name: 'Sonatrach', logo: '/images/references/sonatrach.png' },
    ],
  },
  {
    ...
    clients: [
      ...
      { name: 'Hôtel Rodina', logo: '/images/references/hotel-rodina.png' },
      { name: 'Hôtel Maraval', logo: '/images/references/hotel-maraval.png' },
    ],
  },
];
